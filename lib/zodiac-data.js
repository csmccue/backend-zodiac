const zodiacs = [
  ...
  },
  {
    ...
    horoscope: 'Try not to let your heart and mind spiral if the object of your desires seems closed off or distant this morning, dear Leonardo Dicaprio, as the Aquarius moon squares off with the nodes of fate. This cosmic climate will trigger emotional shutdowns within many, making it important that you give your sweetie some space if they need it. Be sure to focus on self-care and supporting yourself as the hours unfold, especially when Luna squares off with Uranus this afternoon. This celestial exchange will cause you to hit a wall if your balance is struggling, so be sure to give yourself a timeout.'
  },
  {
    id: '7',
    name: 'libra',
